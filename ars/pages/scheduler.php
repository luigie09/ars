...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <br/>
            <br/>
<a href="/ars/pages/scheduler.php?eid=<?php echo $eid; ?>" class="btn btn-warning col-md-4 col-xs-4 col-md-offset-1 col-xs-offset-1 active">Business Class</a>
<a href="/ars/pages/first_class.php?eid=<?php echo $eid; ?>" class="btn btn-warning col-md-4 col-xs-4 col-md-offset-2 col-xs-offset-2">Economy Class</a>
...
<table cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered col-md-12 col-xs-12">
    ...
    <tbody><?php 
        ...
        <tr class="gradeX">
            ...
            <td><center><?php echo $keps['one']; ?></center></td>
            <td><center><?php echo $keps['flight_date']; ?></center></td>
            <td><center><a href="/ars/pages/view_flight.php?eid=<?php echo $eid; ?>&flight=<?php echo $keps['flight_number']; ?>&class=1" class="btn btn-info col-md-12 col-xs-12">View </a>        
            <td><center><a href="/ars/process/delete_flight.php?eid=<?php echo $eid; ?>&flight=<?php echo $keps['flight_number']; ?>" class="btn btn-danger col-md-12 col-xs-12">Delete Flight</a>
                ...
                <a href="/ars/process/logout.php?eid=<?php echo $eid; ?>" class="btn btn-info col-md-2 col-xs-2 col-md-offset-1 col-xs-offset-1">Logout</a>
...
<?php 
    ...
    header("location:/ars/process/logout.php");
}
?>