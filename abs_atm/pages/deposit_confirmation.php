			...
			<div class="row">
				<div class="big_text panel panel-default col-md-10 col-xs-10 col-md-offset-1 col-xs-offset-1">	<br/>
					<h4><center>CONFIRM DEPOSIT</center></h4>
						...
						<a class="btn btn-danger col-md-5 col-xs-5" href="/abs/process/input_deposit.php?edom=<?php echo $voodoo; ?>&amount=<?php echo $_POST['deposit_amount']; ?>" name = "deposit_me">CONFIRM</a>
						<a class="btn btn-info col-md-5 col-xs-5 col-xs-offset-1" href="deposit_slip.php?edom=<?php echo $voodoo; ?>">GO BACK</a>
						<br/><br/>
						<br/>
						</div><br/>
					</div><br/>
