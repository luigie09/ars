		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		        <center>
		        	<ul class="nav navbar-nav navbar-right links">
		        		<li class="active"><a href="/abs_atm/pages/user.php?edom=<?php echo $voodoo; ?>">Savings <text1>Account</text1></a></li>
		        		<li class="divider"></li>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="big_text panel panel-default col-md-10 col-xs-10 col-md-offset-1 col-xs-offset-1">	<br/>
					<h4><center>DEPOSIT FORM</center></h4>
						<div class="col-md-8 col-xs-8 col-md-offset-2 col-xs-offset-2">

					<form role="form" action="/abs/pages/deposit_confirmation.php?card_num=<?php echo $card_num; ?>" method="POST" >
					...
					<br/> 
					 <input type="submit" class="btn btn-info col-md-12 col-xs-12" name="deposit_activate" value="DEPOSIT">
					</form>
						</div>
					<br/>
				</div>
